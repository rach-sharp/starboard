...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///starboard'),
}
...
MIGRATION_MODULES = {
    'sites': 'starboard.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'starboard.users.adapters.SocialAccountAdapter'
